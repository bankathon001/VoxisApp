                    ...
                    new Handler.Callback() {
                        ...
                        public boolean handleMessage(@NonNull Message msg) {
                            if (msg.what == TIMEOUT_TRIGGER) {
                                ...
                                StrokeManager.this.commitResult();
                                return true;
                            }
        ...
        return modelManager
                ...
                .addOnSuccessListener(new OnSuccessListener<String>() {
                    ...
                    public void onSuccess(String unused) {
                        StrokeManager.this.refreshDownloadedModelsStatus();
                    }
                })
                .onSuccessTask(
                        new SuccessContinuation<String, Void>() {
                            @NonNull
                            @Override
                            public Task<Void> then(@Nullable String status) throws Exception {
                                StrokeManager.this.setStatus(status);
                ...
                .onSuccessTask(
                        new SuccessContinuation<Boolean, String>() {
                            ...
                            public Task<String> then(@Nullable Boolean result) throws Exception {
                                if (!result) {
                                    StrokeManager.this.setStatus("Model not downloaded yet");
                                    return Tasks.forResult(null);
                                }
        ...
        modelManager
                ...
                .addOnSuccessListener(
                        new OnSuccessListener<Set<String>>() {
                            @Override
                            public void onSuccess(Set<String> downloadedLanguageTags) {
